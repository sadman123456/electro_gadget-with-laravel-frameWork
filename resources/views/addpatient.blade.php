                              ...
                              @csrf
                                <div class="row">
                                  ...
                                  <div class="col-md-6" style="padding: 15px; margin-left:25px;">
                                        ...
                                        <textarea class="form-control" name="address" id="exampleFormControlTextarea1" cols="1" rows="1"></textarea>           
                                    </div>
                                ...
                                <div class="col" style="padding: 15px; margin-left:25px;">                  
                                    ...
                                    <input type="datetime-local" name="last_visited" class="form-control" >
                                  </div>
