                        ...
                        <section class="content-header">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-6" style="padding: 25px;">
                                    <a href="{{route('brands.index')}}"> <button type="button" class="btn btn-primary">Back
                                            Brand List</button></a>
                                                    ...
                                                    <table id="datatable" class=" table-striped" role="grid" aria-describedby="datatable_info" style="text-align: center;">
                                                        ...
                                                        <tbody id="">
                                                            ...
                                                            <tr role="row" class="odd" style="height: 75px; padding: 25px">
                                                                ...
                                                                <td class="c_center " style="padding: 22px;">
                                                                    <a href="{{ route('brands.restore', $brand->id) }}"> <button type="button" class="btn btn-primary">Restore</button></a>

                                                                </td>
                                                                <td class="c_center " style="padding: 22px;">
                                                                    <a href="{{ route('brands.delete', $brand->id) }}"> <button class="btn btn-sm btn-outline-danger" onclick="return confirm('Are You sure want to delete ')">Delete</button></a>
