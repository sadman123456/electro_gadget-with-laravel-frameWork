                                                    ...
                                                    <table id="datatable" class=" table-striped" role="grid" aria-describedby="datatable_info" style="text-align: center;">
                                                        ...
                                                        <tbody id="">
                                                            ...
                                                            <tr role="row" class="odd" style="height: 75px; padding: 25px">
                                                                <td class="c_center " style="padding: 25px;">{{ $categories->id }}</td>
                                                                <td class="c_center " style="padding: 25px;">{{ $categories->name }}</td>
                                                                <td class="c_center " style="padding: 25px;">{!! $categories->description !!}</td>
                                                                ...
                                                                <td class="c_center " style="padding: 22px;">
                                                                    <a href="{{ route('category.show', $categories->id) }}"> <button type="button" class="btn btn-success">show</button></a>

                                                                </td>

                                                                <td class="c_center " style="padding: 22px;">
                                                                    <a href="{{ route('category.edit', $categories->id) }}"> <button type="button" class="btn btn-primary">Edit</button></a>
