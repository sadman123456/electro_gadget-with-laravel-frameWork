          ...
          <div class="col-lg-12 col-sm-12">
            ...
            <section class="content">
              <form action="{{route('colors.update', $color->id )}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  <x-forms.input name='name' label='Color name' placeholder="Color name" :value="old('name',$color->name)" required />
                  <x-forms.input type='color' label='Code' name='code' :value="old('code',$color->code)" placeholder="Color" required />
                ...
                <div class="row">
                  ...
                  <x-forms.select name="brand_id" label="Brand" :options="$brands" :selected="old('brand_id',$color->brand_id)" required />
